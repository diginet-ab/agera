...
class KitchenSinkService {
    ...
    graph: joint.dia.Graph | undefined;
    paper: joint.dia.Paper | undefined;
    paperScroller: joint.ui.PaperScroller | undefined;

    commandManager: joint.dia.CommandManager | undefined;
    snaplines: joint.ui.Snaplines | undefined;
    clipboard: joint.ui.Clipboard | undefined;
    selection: joint.ui.Selection | undefined;
    navigator: joint.ui.Navigator | undefined;
    ...
    constructor(
        public form: string,
        public onFormChange: (newForm: string) => void,
        el: Element,
        stencilService: StencilService,
        toolbarService: ToolbarService,
        inspectorService: InspectorService,
    ...
    initializePaper() {
        ...
        paper.on('blank:mousewheel', _.partial(this.onMousewheel), this);
    ...
    applyOnSelection(method: string) {
        ...
        this.selection!.collection.models.forEach(model => { (model as any)[method](); });
    ...
    changeSnapLines(checked: boolean) {
        ...
        if (checked) {
            ...
            this.stencilService.stencil!.options.snaplines = undefined;
        }
    }
    ...
    openAsSVG() {
        ...
        const newForm = JSON.stringify(this.graph?.toJSON())
        window.localStorage.setItem("Dashboard.form", newForm)
    ...
    openAsPNG() {
        ...
        if (this.form) {
            ...
            this.graph!.fromJSON(JSON.parse(this.form))
        }       
